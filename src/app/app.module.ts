...
import { GroupSelectable2Component } from './components/group-selectable2/group-selectable2.component';
@NgModule({
  declarations: [AppComponent, PersonModalComponent, GroupSelectableComponent,GroupSelectable2Component],
  imports: [
    BrowserModule, 
    IonicModule.forRoot(), 
    AppRoutingModule,
